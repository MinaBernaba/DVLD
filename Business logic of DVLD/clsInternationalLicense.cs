...
namespace BusinessLogicOfDVLD
{
    public class clsInternationalLicense : clsApplication
    {
            ...
            DateTime IssueDate, DateTime ExpirationDate, bool IsActive)
        {
            ...
            base.PersonInfo = clsPerson.Find(base.ApplicantPersonID);
            base.ApplicationTypeInfo = clsApplicationType.Find(base.ApplicationTypeID);
            base.UserInfo = clsUser.FindUser(base.CreatedByUserID);
